...
const Footer = () => {
  return (
    <footer className="bg-[#0d0d0d] text-gray-300 mt-20 pt-16 px-6 md:px-16 lg:px-24 xl:px-32">
      
      {/* TOP SECTION */}
      <div className="flex flex-wrap justify-between gap-10 pb-12 border-b border-gray-700">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="text-gray-400 leading-6">
            Premium rental services for luxury, economy, and everyday vehicles.
            Fast booking, great prices, and a seamless experience.
          </p>

          {/* Social icons */}
          <div className="flex items-center gap-4 mt-6">
            <a href="#" className="hover:opacity-80 transition">
              <img src={assets.facebook_logo} className="w-5" />
            </a>
            <a href="#" className="hover:opacity-80 transition">
              <img src={assets.instagram_logo} className="w-5" />
            </a>
            <a href="#" className="hover:opacity-80 transition">
              <img src={assets.twitter_logo} className="w-5" />
            </a>
            <a href="#" className="hover:opacity-80 transition">
              <img src={assets.gmail_logo} className="w-5" />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/owner" className="hover:text-white transition">List an Item</Link></li>
          </ul>
        </div>
      ...
      {/* BOTTOM SECTION */}
      <div className="flex flex-col md:flex-row items-center justify-between py-6 text-gray-400">
